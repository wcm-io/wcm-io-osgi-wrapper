 ...
 * #L%
 */
package io.wcm.wrapper.cxf.logging;
 ...
 * </p>
 * <p>
 * Methods {@link java.util.logging.Logger#setParent(java.util.logging.Logger)},
 * {@link java.util.logging.Logger#getParent()},
 ...
 * </pre>
 */
public class SlingCompatibleSlf4jLogger extends AbstractDelegatingLogger {
   ...
   */
  public SlingCompatibleSlf4jLogger(String name, String resourceBundleName) {
  ...
  protected void internalLogFormatted(String msg, LogRecord record) {
    ...
    /*
     * As we can not use a "switch ... case" block but only a "if ... else if ..." block, the order of the comparisons is important. We first try log level FINE
     * then INFO, WARN, FINER, etc
     */
